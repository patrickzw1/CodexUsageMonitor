...
internal static class ThemeManager
{
    ...
    [
        ...
        ("FlyoutSurfaceBrush", "#FFF9FBFE", "#FF232A36"),
        ("FlyoutBorderBrush", "#FFCBD3E1", "#FF465064"),
        ...
        ("SelectionBrush", "#FFDCE7FF", "#FF34445F"),
        ("SelectionHoverBrush", "#FFD1DFFF", "#FF3D506F"),
        ...
        ("DisabledTextBrush", "#7C8492", "#8590A2"),
        ("AccentBrush", "#315FC7", "#85A8FF"),
        ("AccentHoverBrush", "#2853B0", "#FF9AB9FF"),
        ("AccentPressedBrush", "#214795", "#FF7096EC"),
        ("AccentSubtleBrush", "#26315FC7", "#3885A8FF"),
        ("AccentFaintBrush", "#14315FC7", "#2085A8FF"),
        ("OnAccentBrush", "#FFFFFFFF", "#FF10131A"),
        ("AccentFocusBrush", "#3978E7", "#FFAAC4FF"),
        ("ButtonSecondaryBrush", "#D9DEE7", "#FF3A4352"),
        ("ButtonSecondaryHoverBrush", "#C9D0DB", "#FF465264"),
        ("ButtonSecondaryPressedBrush", "#B8C2D0", "#FF556278"),
        ("ButtonSecondaryBorderBrush", "#FF6B778A", "#FF7A879D"),
        ("ErrorBrush", "#B42318", "#FFFF8A80"),
        ("OnErrorBrush", "#FFFFFFFF", "#FF1A0B0A"),
        ("ButtonDangerHoverBrush", "#961E16", "#FFFFAAA3"),
        ("ButtonDangerPressedBrush", "#7A1812", "#FFF56F65"),
